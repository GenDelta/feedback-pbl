...
import {
  ...
  hasFacultySubmittedCurriculumFeedback,
  submitFacultyCurriculumFeedback,
  Question,
...
const CurriculumFeedbackPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (facultyInfo) {
          ...
          const submitted = await hasFacultySubmittedCurriculumFeedback(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit feedback
      const result = await submitFacultyCurriculumFeedback(
        facultyId,
        processedResponses
      );
