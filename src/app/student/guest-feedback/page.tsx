    ...
    const fetchData = async () => {
      try {
        ...
        if (studentInfo) {
          ...
          // Check if student has already submitted guest feedback
          const submitted = await hasStudentSubmittedFeedback(
            studentInfo.id,
            "Guest Curriculum Feedback" // Changed to match database
          );
        ...
        // Get guest feedback questions
        const questionsData = await getGuestFeedbackQuestions();
        ...
        <div className="max-w-4xl mx-auto w-full flex-grow flex items-center justify-center">
          <div className="bg-gray-700 p-8 rounded-lg text-center">
            <div className="bg-yellow-600 text-white p-4 rounded-md mb-4">
              ...
              <p>You have already submitted guest feedback.</p>
            </div>
